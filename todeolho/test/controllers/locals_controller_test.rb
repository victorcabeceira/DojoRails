...
class LocalsControllerTest < ActionController::TestCase
  ...
  test "should create local" do
    assert_difference('Local.count') do
      post :create, local: { cep: @local.cep, municipio: @local.municipio, references: @local.references, uf: @local.uf }
    end
  ...
  test "should update local" do
    patch :update, id: @local, local: { cep: @local.cep, municipio: @local.municipio, references: @local.references, uf: @local.uf }
    assert_redirected_to local_path(assigns(:local))
  end
