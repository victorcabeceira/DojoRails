...
class ConcedentesControllerTest < ActionController::TestCase
  ...
  test "should create concedente" do
    assert_difference('Concedente.count') do
      post :create, concedente: { codigo: @concedente.codigo, nome: @concedente.nome, references: @concedente.references }
    end
  ...
  test "should update concedente" do
    patch :update, id: @concedente, concedente: { codigo: @concedente.codigo, nome: @concedente.nome, references: @concedente.references }
    assert_redirected_to concedente_path(assigns(:concedente))
  end
